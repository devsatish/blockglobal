package io.blockglobal.exchange.repository;

import io.blockglobal.exchange.BlockglobalApp;
import io.blockglobal.exchange.config.Constants;
import io.blockglobal.exchange.config.audit.AuditEventConverter;
import io.blockglobal.exchange.domain.PersistentAuditEvent;
...
import static io.blockglobal.exchange.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
