package io.blockglobal.exchange.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("blockglobal");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("blockglobal");
        ...
        config.getMapConfigs().put("io.blockglobal.exchange.domain.*", initializeDomainMapConfig(jHipsterProperties));
